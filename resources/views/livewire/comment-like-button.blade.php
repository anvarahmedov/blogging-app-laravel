<button wire.loading.attr = "disabled" wire:click='toggleLike()' class="flex items-center">
    <svg wire:loading.delay aria-hidden="true"
        class="w-6 h-6 text-gray-200 animate-spin dark:text-gray-600 fill-purple-600" viewBox="0 0 100 101" fill="none"
    ...
    <svg wire:loading.delay.remove xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
        ...
        class="w-6 h-6 {{ Auth::user()?->hasLikedComment($comment) ? 'text-purple-600' : 'text-gray-600' }} hover:text-gray-900">
